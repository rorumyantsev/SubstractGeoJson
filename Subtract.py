...
st.write(Zone1_json['Coordinates']
Zone_to_substract_from = shapely.geometry.Polygon(Zone1_json['Coordinates'])
...
result = (Zone_to_be_substracted_from.difference(Zone_to_be_substracted))
